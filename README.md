...
- Нет сквозного шифрования — безопасность обеспечивает ваш почтовый провайдер (TLS в транзите). Meridian Mail — инструмент **доступности и удобства**, не приватности.
